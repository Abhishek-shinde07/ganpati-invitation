...
export default function Invitation() {
  ...
  return (
    <div className="relative min-h-screen bg-[#120502] text-[#3D1E03] font-serif overflow-x-hidden flex justify-center items-center">
      ...
      >
        {/* Soft Overlay */}
        <div className="absolute inset-0 bg-[#FFFDF8]/41 pointer-events-none z-0" />
        ...
        <div className="w-full flex-1 flex flex-col items-center px-6 pt-16 pb-12 relative z-10">
          ...
          >
            ...
            >
              ...
              <img 
                src="/ganpati.png" 
                alt="Lord Ganesha"
                className="w-11/12 h-11/12 object-contain relative z-10 drop-shadow-[0_10px_20px_rgba(255,215,0,0.25)] mt-6"
              />
            </div>
          </motion.section>
          ...
          >
            ...
            <p className="text-base font-bold text-[#701A33] leading-relaxed mb-2">
              Your presence is the greatest blessing for our celebrations.
            </p>
